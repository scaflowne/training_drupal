 ...
 *   handlers = {
 *     "storage" = "Drupal\bits_entities\BitsEntitiesMessageStorage",
 ...
 *     "translation" = "Drupal\bits_entities\BitsEntitiesMessageTranslationHandler",
 *
 *     "form" = {
 ...
 *     "add-form" = "/admin/structure/bits_entities_message/add",
 ...
 *   },
 *   field_ui_base_route = "bits_entities_message.settings"
 * )
 */
class BitsEntitiesMessage extends EditorialContentEntityBase implements BitsEntitiesMessageInterface {
  ...
  public function preSave(EntityStorageInterface $storage) {
    ...
    // make the bits_entities_message owner the revision author.
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['user_id'] = BaseFieldDefinition::create('entity_reference')
      ...
      ->setLabel(t('User to'))
      ->setDescription(t('The user to sending of the message.'))
      ->setRevisionable(TRUE)
      ->setSetting('target_type', 'user')
      ->setSetting('handler', 'default')
      ->setTranslatable(TRUE)
    ...
    $fields['is_read'] = BaseFieldDefinition::create('boolean')
      ->setLabel(t('Is read'))
      ->setDescription(t('The message is read'))
      ->setRevisionable(TRUE)
      ->setTranslatable(TRUE)
      ->setDisplayOptions('form', [
    ...
    $fields['status']->setDescription(t('A boolean indicating whether the Message is published.'))
      ->setDisplayOptions('form', [
        'type' => 'boolean_checkbox',
        'weight' => -3,
      ]);
